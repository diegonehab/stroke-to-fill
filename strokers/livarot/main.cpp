...
int main(void) {
    ...
    auto input_shape = svg_shape("M,489.0625,21.25,C,212.1875,19.583333333333314,471.5625,368.75,222.8125,379.58333333333331");
    float width = 20.f;
...
<svg
   ...
   width="172.31844">
    ...
    xform id;
    auto output_shape = stroker::livarot_outline(input_shape, id, width, style);
